...
| 31/3 | 1h | Exported all files and uploaded to GitHub and added imgs 🎉 Also today I learned that we can move components using the mouse and no need to use M key 😂 Also added the BOM and don’t judge me okay I still use Excel 😭 Made some minor changes in my drawing |  |
| 1/4 | 30min | Tried to find for cheap but shii didn’t got any and even if I got they have no HCB support |  |
...
| 1/4 | 1h | After 2hr idler pulley was done but shi the pulley wasn’t aligning with the stepper motor pulley height then had to do some cut here and there so it matched the heights |  |
...
| 2/4 | 1h | Z axis holder but for the top — added the KFL008 bearing to it and expanded area of that so the screw holes match and assembled that into "bot asm" file (printer's assembly) |  |
...
| 7/4? | 2–3h | Learned what the hell is Core XY… as I am fked… I am going to Core XY now as I can’t do tool heads with Cartesian… why am I so dumbm… Nooooo |  |
| 7/4 | 1h | Made the X axis rail holder |  |
| 7/4 | 1h | Worked with the X axis but this shi is hard and I am crashing out because I did HackDucky YSWS PCB (PCB team), then infill… it’s ig 15h me being near the screen… I am feeling so sleepy fk |  |
...
|10/4|10mins|added a diff mmu as the one i made has p low chances of surviving||
|12\8|3HRR |MADE THE HOTEND FINER LIKE REMOVED MANY UBUMPS AND ALL AND wait why tf is it caps 😭 soo. and added the a support with v weels to the build plate z axis so the buildplate doesnt wobble much ..|   ![image](https://github.com/user-attachments/assets/8d17649a-b4b4-4dd2-8f0c-24716cc98a78)|
|12\8|1HRR |remade the bom idk why now its 20$ cheaper lol |[new](https://docs.google.com/spreadsheets/d/1VOcx1vCP93SXvwvrw4UESpFi0AxCleXlYnAZV9N3jMY/edit?usp=sharing) new.. old = [old](https://docs.google.com/spreadsheets/d/1GsGL4ULE8kVeCzovQZRwg6a7aZ0rBIDmCoE6IRLUSBg/edit?gid=1551091323#gid=1551091323)|
---
